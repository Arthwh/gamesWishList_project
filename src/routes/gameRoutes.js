import { getGamesPage, getGameInfoPage, getUserGamesPage, addGameToList, deleteGameFromList, editGameStatusFromList, getUserGamesList, getUserListId, getSharedList } from '../controllers/gameController.js';
